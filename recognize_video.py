...
recognizer = pickle.loads(open('E:/Face recognition/opencv-face-recognition/opencv-face-recognition/Recognizer', "rb").read())
le = pickle.loads(open('E:/Face recognition/opencv-face-recognition/opencv-face-recognition/LabelEncoder', "rb").read())
...
vs.stop()
vs.stream.release() #Turns off webcam totally!